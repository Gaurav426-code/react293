    ...
    <div className="container my-5 bg-gradient">
      ...
      <div className='row  border shadow bg-primary '>
        ...
        <div className= 'col-6 mb-6 g-2 '>
         ...
         <Link to="/dashboard"><button className='mb-4 w-50 gradient-custom-2 p-2 text-white' onClick={mylogin}>Log In</button></Link>
            <br/>
       ...
       <Link to="/userregister"><button className='mx-2 p-1   border border-danger  text-danger'>Create Account
        ...
        <div className="col md-6 g-0 bg-white">
          <div className="d-flex flex-column  justify-content-center gradient-custom-1 h-100 mb-4">
            ...
            <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.svg" alt='admin_login_pic' className='img-fluid'style={{background:'cover'}}/>
            </div>
